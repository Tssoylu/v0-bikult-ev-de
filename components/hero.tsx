          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mt-12 grid grid-cols-3 gap-6 lg:gap-8">
              <div className="text-center lg:text-left">
                ...
                <div className="text-sm text-muted-foreground mt-1">Teilnehmer</div>
              </div>
              <div className="text-center lg:text-left">
                <div className="font-serif text-3xl lg:text-4xl font-bold text-foreground">10+</div>
                <div className="text-sm text-muted-foreground mt-1">Jahre Erfahrung</div>
              </div>
              <div className="text-center lg:text-left">
                <div className="font-serif text-3xl lg:text-4xl font-bold text-foreground">15+</div>
                <div className="text-sm text-muted-foreground mt-1">Kurse</div>
              </div>
            </div>
          </div>
