    ...
    <section id="projects" className="py-20 lg:py-32 bg-[#FAFAFA] text-foreground dark:bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 text-center">
          <Link
            href="/projekte"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-primary text-primary-foreground hover:bg-primary/90 font-medium transition-colors shadow-sm"
          >
